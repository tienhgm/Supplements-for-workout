...
<?php $discountProduct = $this->modelDiscountProduct(); //Home Model?>
<?php foreach($discountProduct as $rows): ?>
<!-- sp -->
<div class="col-md-2" style="padding: 20px 7px;">
	<div class="box-product">
		<div class="tagtick">
			<div class="noibat1">-<?php echo $rows->discount;?>%</div>
		</div>
		<div class="img-pr"><a href="products/detail/<?php echo Unicode::removeUnicode($rows->name);?>/<?php echo $rows->id;?>"><img src="../Assets/Upload/Products/<?php echo $rows->photo;?>" alt="" ></a></div>
		<div class="caption">
