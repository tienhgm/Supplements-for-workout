  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">SB Tienad <sup>2</sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?controller=categories&action=read">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?controller=products&action=read">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="index.php?controller=orders&action=read">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?controller=users&action=read">
